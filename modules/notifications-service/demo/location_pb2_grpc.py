...
class LocationStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.LocationCheckIn = channel.stream_stream(
                '/greet.Location/LocationCheckIn',
...
def add_LocationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'LocationCheckIn': grpc.stream_stream_rpc_method_handler(
                    servicer.LocationCheckIn,
...
class Location(object):
    ...
    @staticmethod
    def LocationCheckIn(request_iterator,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/greet.Location/LocationCheckIn',
