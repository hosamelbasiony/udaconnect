...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "master" do |master|
    ...
    master.vm.network 'private_network', ip: "192.168.50.5",  virtualbox__intnet: true
    master.vm.network "forwarded_port", guest: 22, host: 2222, id: "ssh", disabled: true
    master.vm.network "forwarded_port", guest: 22, host: 2000 # Master Node SSH
    master.vm.network "forwarded_port", guest: 22, host: 22 # Master Node SSH
    master.vm.network "forwarded_port", guest: 6443, host: 6443 # API Access
    master.vm.network "forwarded_port", guest: 10000, host: 10000 # API Access
